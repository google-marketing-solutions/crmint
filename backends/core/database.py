...
def load_fixtures(logger_func=None):
  ...
  general_settings = ['client_id', 'client_secret', 'emails_for_notifications',
  'google_ads_authentication_code', 'google_ads_refresh_token', 'developer_token',
   'app_conversions_and_remarketing_developer_token']
