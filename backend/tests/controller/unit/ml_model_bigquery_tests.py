...
class TestClient(absltest.TestCase):
  ...
  def test_get_analytics_variables(self, query_mock: mock.Mock, get_table_mock: mock.Mock):
    ...
    # check name and result order is correct (query returns ASC and results should be in DESC)
  ...
  def test_get_first_party_variables(self, get_table_mock: mock.Mock):
    ...
    variables = self.client.get_first_party_variables('test-first-party-dataset')
